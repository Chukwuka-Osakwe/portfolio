...
summary: "Redesigning the Heyfood checkout — splitting one overloaded screen into a two-step flow that surfaces decisions at the moment they become relevant."
blurb: "A cluttered single-screen checkout, redesigned around how people actually make purchase decisions."
date: "2024-06-01"
type: "PRODUCT DESIGN"
image: "/work/heyfood/heyfood-cover-v2.webp"
featured: true
---
...
{/* Walkthrough of the redesigned flow. 18rem matches `current-checkout` above
    so the two phone shots in this case study read at the same visual weight.
    User-initiated: frosted poster at rest → native controls on play. */}
<CaseVideo
  src="/work/heyfood/heyfood.mp4"
  poster="/work/heyfood/heyfood-poster.webp"
  width="18rem"
  caption="The redesigned flow in motion."
/>
